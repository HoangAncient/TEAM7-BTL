            ...
            <fieldset class="Fieldset">
                ...
                <div class="parent">
                    <div class="child">Question:
                        <br>
                        <textarea id="quest" type="text" name="quest"></textarea>
                        Description picture:
                        <br>
                    ...
                    <div class="child">
                        ...
                        <br>
                        Explanation:<br>
                        <textarea id="quest" type="text" name="explaination"></textarea>
                        <br>
                        <br>
                    </div>
                </div>
...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($check_uploaded == false) {
            $sql = "INSERT INTO question(quest,answer1,answer2,answer3,answer4,ranswer, explaination, bankID, chapter) VALUES ('$quest','$answer1','$answer2','$answer3','$answer4','$ranswer', '$explaination', '134', '$chapter')";
        } else {
            $sql = "INSERT INTO question(quest,filepath, answer1,answer2,answer3,answer4,ranswer, explaination, bankID, chapter) VALUES ('$quest','$reFilename' ,'$answer1','$answer2','$answer3','$answer4','$ranswer', '$explaination', '134', '$chapter')";
