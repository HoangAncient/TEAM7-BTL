...
<body>
    <div class="container-fluid" id="direction" style="z-index: 1">  
        <button class="btn" style="float: left; margin-left: 5%; margin-right: auto"> <i class="bi bi-arrow-left" style="margin-right: 5%"></i> <a href="studentIndex.php">Back</a></button>
