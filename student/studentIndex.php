...
<head>
    ...
    <body>
        ...
        <nav class="nav position-fixed flex-nowrap h-100">
            <div class="container-fluid flex-column">
                <ul class="nav flex-column align-items-center">
                    <li class = "nav-item">
                        <a class="nav-link align-item-center" style="color:#000000" href=""><i class="fa fa-home"  aria-hidden="true"></i><br>Home</a>
                    </li>
                    <li class = "nav-item">
                        <a href=""><img src="../assets/image/icon/HomeButton.svg" alt=""></a>
                    </li>
                    <li class = "nav-item">
                        <a href=""><img src="../assets/image/icon/HomeButton.svg" alt=""></a>
                    </li>
